...
from services.itinerary_service.routes import router as itinerary_router
...
api_router.include_router(itinerary_router, prefix="/itineraries", tags=["itineraries"])
